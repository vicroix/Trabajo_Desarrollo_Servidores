            ...
            <div class="col-md-4 p-5 acceder-cuenta">
                ...
                <form action="../auth/servidor.php" method="post" class="p-4">
                    ...
                    <div class="text-center p-3">
                        No tienes cuenta, <a href="../auth/registro.php">crea una cuenta</a>
                    </div>
                </form>
            </div>
        </div>
