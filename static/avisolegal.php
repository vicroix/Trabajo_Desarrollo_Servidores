    ...
    <div class="container Cmy-5 cuerpo-pagina">
        <div class="row justify-content-center">
            <div class="col-md-12 p-5 contenido-cuerpo">
                <h1>Aviso Legal</h1>
                <div>
                    <p><strong>Atención al Cliente: 999999999</strong></p>

                    <p class="contact-info">
                        Medaczapato pertenece a:<br>
                        Medaczapato S.L.<br>
                        C/ Medaczapato, 1<br>
                        29000 Málaga<br>
                        España<br>
                        CIF: B-99999999<br>
                        Correo electrónico: <a href="mailto:avisolegal@medaczapato">avisolegal@medaczapato.es</a><br>
                        Tlf: 999 999 999<br>
                        Fax: 999 999 999
                    </p><br>
                </div>
                ...
                <p>
                    ...
                    <strong>Cargo:</strong> Director General<br>
                    <strong>Correo electrónico:</strong> <a href="mailto:"></a><br>
                </p>
                </p><br>

                <h3 class="section-title">Presidente del Consejo de Viligancia:</h3>
                <p>
                    <strong>Nombre:</strong> Juan Pérez<br>
                    <strong>Cargo:</strong> Director General<br>
                    <strong>Correo electrónico:</strong> <a href="mailto:"></a><br>
