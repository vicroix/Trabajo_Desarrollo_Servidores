...
<body>
    ...
    <nav class="navbar navbar-expanded m-0 p-0">
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <a href="../static/carrito.php" class="btn btn-outline-primary position-relative ms-2 mx-3 carritoCompra">
                    ...
                    <span class="position-absolute top-0 start-90 translate-middle badge rounded-pill bg-danger">
                        0 <!-- Cantidad de artículos en la cesta -->
                    </span>
                </a>
            </div>
            <?php
            ...
            <?php else: ?>
                <form action="cerrarSesion.php" method="post" class="cerrar">
    ...
    <footer class="footer">
        ...
        <div class="seccion-footer">
            ...
            <div class="iconos-de-pago">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="excepcion">
