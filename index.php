...
<body>
    ...
    <nav class="navbar navbar-expanded m-0 p-0">
        <div class="container-fluid">
            ...
            <ul class="d-flex menu-pricipal">
                <li class="dropdown d-flex p-3 ms-3"><a href="" class="titulo-menu-principal">Hombre</a>
                ...
                <li class="d-flex p-3 ms-3"><a href="" class="titulo-menu-principal">Mujer</a>
                    <ul class="dropdown-menu submenu ms-0 m-3">
                        <li><a class="dropdown-item" href="#">Running</a></li>
                        <li><a class="dropdown-item" href="#">Casual</a></li>
                        <li><a class="dropdown-item" href="#">Fútbol</a></li>
                ...
                <li class="d-flex p-3 ms-3"><a href="" class="titulo-menu-principal">Niños</a>
                    <ul class="dropdown-menu submenu ms-0 m-3">
                ...
                <li class="d-flex p-3 ms-3"><a href="" class="titulo-menu-principal">Niñas</a>
                    <ul class="dropdown-menu submenu ms-0 m-3">
                        <li><a class="dropdown-item" href="#">Deporte</a></li>
                        <li><a class="dropdown-item" href="#">Casual</a></li>
                        <li><a class="dropdown-item" href="#">Fútbol</a></li>
                ...
                <li class="d-flex p-3 ms-3"><a href="" class="titulo-menu-principal">Marcas</a>
                    <ul class="dropdown-menu submenu ms-0 m-3">
            ...
            <div class="d-flex align-items-center">
                <a href="static/carrito.php" class="btn btn-outline-primary position-relative ms-2 mx-3 carritoCompra">
            ...
            if (!isset($_SESSION["id"])): ?>
                <button class="btn btn-outline-success boton-login" data-bs-toggle="dropdown" onclick="window.location.href='static/login.php'">
    ...
    <div class="container mt-4 d-flex justify-content-center content-cards">
        <div class="row">
            <?php
            $result = mysqli_query($mysqli, "SELECT * FROM productos ORDER BY id ASC");
            while ($res = mysqli_fetch_array($result)) {
                $modalId = "imageModal" . $res['id']; // Genera un ID único para cada modal
            ?>
                <div class="col-md-3 content-cards p-2">
                    <div class="card">
                        <a href="" onclick="openModal('<?php echo $modalId; ?>', event)"><img src="images/productos/<?php echo $res['imagen']; ?>" class="card-img-top" alt="<?php echo $res['nombre']; ?>"></a>
                        <!-- Ventana emergente -->
                        <div id="<?php echo $modalId; ?>" class="custom-modal">
                            <div class="modal-content">
                                
                                <button class="close-btn" onclick="closeModal('<?php echo $modalId; ?>')">×</button>
                                <img src="images/productos/<?php echo $res['imagen']; ?>" alt="<?php echo $res['nombre']; ?>">
                            </div>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $res['nombre']; ?></h5>
                            <strong>
                                <p class="card-text"><?php echo $res['precio']; ?> €</p>
                            </strong><br>
                            <a href="static/carrito.php?id=<?php echo $res['id']; ?>" class="btn btn-primary">Añadir al carrito</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
    ...
    <footer class="footer mt-5">
        ...
        <div class="seccion-footer">
            ...
            <ul>
                <li><a href="static/condiciones.php">Condiciones de uso</a></li>
                <li><a href="static/avisolegal.php">Aviso Legal</a></li>
